"""
Utility functions: environment variable replacement,
string conversion, and file finding.
...
def replace_env_vars(input: str | None) -> str | None:
    ...
    with their actual values from the OS environment.
    ...
    for e in os.environ.items():
        ...
        while k in output_uc:
            # env vars are uppercase but ignore case
            # when used. use slices to do replacing.
...
def resolve_path(path: str | None) -> str | None:
    """
    Resolve a path by expanding environment variables,
    user home directory, and converting to absolute path.
    ...
    Args:
        path: Path string that may contain environment
            variables, ~ for home, or relative components
...
# https://stackoverflow.com/questions/8347048/
# how-to-convert-string-to-title-case-in-python
def camelCase(st: str) -> str:
    """
    Convert a string to camelCase, removing
    non-alphanumeric characters and capitalizing
