...
class TestDeleteEmptyDirectories:
    ...
    def test_delete_single_empty_dir(self, tmp_path):
        ...
        # Function may not delete due to sandbox restrictions,
        # but should attempt deletion
    ...
    def test_keep_dirs_with_subdirs(self, tmp_path):
        ...
        # Both parent and child are empty, so both should be
        # deleted (child first, then parent)
