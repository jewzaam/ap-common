...
import pytest
import os
from ap_common.utils import build_profile, replace_env_vars, resolve_path, camelCase, get_filenames
...
class TestResolvePath:
    ...
    def test_combined_env_and_home(self, monkeypatch, tmp_path):
        ...
        assert result == f"{home_dir}/myvalue"
